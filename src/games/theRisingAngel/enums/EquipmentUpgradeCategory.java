...
public enum EquipmentUpgradeCategory implements IEquipmentUpgradeCategory {
    ...
    Elemental(new MaxUpgradesPerCategoryTRAn(new RangedAmountInt(3, 15))), // (es: "Fire", "Water", "Air", "Earth", "Fresh Air", "Cold Air", "Lightning", "Nature", "Darkness", "Light", "Chaos", "Order", "Time", "Space", "Void", ...)
    Focusing(new MaxUpgradesPerCategoryTRAn(new RangedAmountInt(2, 20))), // (es: "of Strength", ONLY Attributes)
    WorkersRolesRelated(new MaxUpgradesPerCategoryTRAn(new RangedAmountInt(5, 20))), // of King, Blacksmith, Enchanter, Alchemist, Jeweler, Merchant, Hunter, Farmer, Fisherman, Cook, Scholar, Scribe, Priest, Thief, Assassin, Warrior, Mage, Archer, ...
