...
// implements GEventObserver
{
	...
	public ADamageReductionOnLifeLowerToPhysicalAttributes(GModality gm) {
		...
		// eventsWatching = Arrays.asList(new String[] {
	...
	// cba = canBeActivated();
	// System.out.println(this.getClass().getSimpleName() + " -> canBeActivated: " +
	// cba);
	// }
	// }
	...
	protected boolean canBeActivated() {
		ObjectWithID o;
		o = this.owner;
		if (o != null && o instanceof LivingObject) {
			return canBeActivated((LivingObject) o);
		}
		return false;
	}
	...
	public void updateAttributesModifiersValues(GModality gm, CreatureSimple ah, CreatureAttributes ca,
		...
		if (canBeActivated(ah)) {
			...
			// System.out.println(this.getClass().getSimpleName() + " -> amount: " +
			// amount);
